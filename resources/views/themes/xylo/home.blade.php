                ...
                <div>
                    <div class="cat-card">
                        <a href="#">
                            ...
                            <div class="catcard-img" style="height: 200px; overflow: hidden; display: flex; align-items: center; justify-content: center; background: #f8f9fa; border-radius: 8px;">
                                @php
                                    $imageUrl = $category->image && file_exists(public_path('images/' . $category->image)) 
                                        ? asset('images/' . $category->image) 
                                        : 'https://via.placeholder.com/300x200?text=' . urlencode($category->translation->name ?? 'Category');
                                @endphp
                                <img src="{{ $imageUrl }}" 
